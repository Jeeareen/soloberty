...
export const Navbar: React.FC = () => {
  ...
  return (
    <header className="sticky top-0 z-50 w-screen max-w-none bg-[#00AAFF] dark:bg-[#B8E7FF] shadow-md h-14 sm:h-16 transition-colors duration-200">
              ...
              return (
                <MotionLink
                  ...
                  className={`relative flex items-center justify-center px-3 sm:px-5 h-full text-xs sm:text-sm font-bold transition-colors whitespace-nowrap shrink-0 ${
                    isAuthTab ? 'w-20 sm:w-24 text-center' : ''
                  } ${
                    isActive
              ...
              {menuOpen && (
                ...
                >
                  ...
                  >
                    ...
                    <div
                      className={`w-9 h-5 rounded-full p-0.5 transition-colors relative ${notificationsEnabled ? 'bg-[#00AAFF] dark:bg-[#B8E7FF]' : 'bg-slate-300 dark:bg-slate-700'
                        }`}
                    >
                      <motion.div
